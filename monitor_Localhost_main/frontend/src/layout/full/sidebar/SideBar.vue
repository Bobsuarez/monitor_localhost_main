...
<!--      manipulacion del avatar imagen -->
      <div class="header-sidebar text-center" slot="header">
        <vs-avatar size="70px" :src="require('@/assets/images/users/soport.png')"/>
        <h4>Soporte<br/>
          <small>soportetecnico@accesspark.co</small>
        </h4>
      </div>
      ...
      <template v-for="(sidebarLink, index) in sidebarLinks">
        ...
        <template v-else-if="!sidebarLink.title">
          ...
          <!-- Dropdown Menu -->
          <template v-else >
            <vs-sidebar-group  :title="sidebarLink.name" :key="sidebarLink.index" :icon-pack="sidebarLink.icon" open="true">
