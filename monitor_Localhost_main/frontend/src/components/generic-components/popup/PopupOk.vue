<template>
  <vs-popup title="Estado de la conexión" :active.sync="popupActivo" button-close-hidden>
    <vs-row vs-justify="center" vs-align="center">
      <vs-col vs-lg="6" vs-sm="6" vs-xs="12">
        <vs-card autofocus actionable>
          <h3 style="text-align: center">{{ establishe }}</h3>
          ...
          <input class="btn-block btn btn-primary submit-button"
                 type="submit"
